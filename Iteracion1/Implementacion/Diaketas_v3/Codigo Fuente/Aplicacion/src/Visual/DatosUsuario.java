...
public class DatosUsuario extends JPanel {
	...
	private TableModel tablaanterior;
...
public DatosUsuario(VentanaPrincipal p) {
		...
		lblEstadoCivil.setBounds(627, 380, 92, 14);
		add(lblEstadoCivil);
		...
		lblEstudios.setBounds(907, 368, 71, 14);
		add(lblEstudios);
	...
	public void settablaanterior(TableModel t){
		tablaanterior=t;
	}
	
	public TableModel gettablaanterior(){
