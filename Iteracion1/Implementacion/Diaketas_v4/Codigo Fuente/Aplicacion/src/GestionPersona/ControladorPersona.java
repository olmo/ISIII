...
public class ControladorPersona {
	...
	private String generaClave(){
		return getCadenaAlfanumAleatoria(8);
	...
	public void introducirDatosSocio(int id, int periocidad){
		String pass = generaClave();
		String user=personaDB.getDatos(id).getApellido1();
		CodificacionPW c=new CodificacionPW(pass);
		Socio s=new Socio(id, periocidad, user, c.getPassword());
	...
	public void introducirDatosTrabajador(int id){
		String pass = generaClave();
		String user=personaDB.getDatos(id).getDni();
		CodificacionPW c=new CodificacionPW(pass);
		Trabajador t=new Trabajador(id, user, c.getPassword());
