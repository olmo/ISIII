...
public class ConfirmarCancelarDonacion extends JDialog {
	
	private Boolean confirmacionModificacion=false;
	public ConfirmarCancelarDonacion() {
		...
		JLabel lblestSeguroQue = new JLabel("¿Está seguro de que quiere cancelar la donación?");
